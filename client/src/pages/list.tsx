...
export default function ListPage() {
  ...
  return (
    <div className="min-h-screen bg-background" data-testid="page-list">
      {/* Header */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-6">
            <button
              ...
              className="p-3 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg min-h-[60px] min-w-[60px]"
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground" data-testid="title-dimension">
                {dimensionLabels[dimension]}
              </h1>
              <p className="text-sm text-muted-foreground" data-testid="text-dimension-description">
            ...
            {filteredTasks.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Try adjusting your filters or sync for new tasks
                </p>
              </div>
            ) : (
